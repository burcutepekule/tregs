...
scenarios      = read_csv('/Users/burcutepekule/Desktop/tregs/mass_sim_results_perturbed/scenarios.csv', show_col_types = FALSE)

# Load all files
params                     = read_csv('/Users/burcutepekule/Desktop/tregs/mass_sim_results_perturbed/loaded_parameters.csv', show_col_types = FALSE)
results_merged             = c()
sterile_comparison_keep    = c()
pathogenic_comparison_keep = c()


path      = "/Users/burcutepekule/Desktop/tregs/mass_sim_results_perturbed/"
...
if(start_id<max_index){
  for (i in start_id:max_index){
    ...
    results         = read_csv(paste0('/Users/burcutepekule/Desktop/tregs/mass_sim_results_perturbed/simulation_results_param_set_',i,'.csv'), show_col_types = FALSE)
