...
GOOGLE COLAB VERSION - Cloud-optimized with relative paths
"""
...
from simulation_utils_G import *
import numba
...
if __name__ == "__main__":
    ...
    results_df.to_csv('simulation_results_py.csv', index=False)
    print(f"✓ Results saved to simulation_results_py.csv")
