...
scenarios      = read_csv('/Users/burcutepekule/Desktop/tregs/mass_sim_results_presampled_123/scenarios.csv', show_col_types = FALSE)

# Load all files
params                     = read_csv('/Users/burcutepekule/Desktop/tregs/mass_sim_results_presampled_123/loaded_parameters.csv', show_col_types = FALSE)
results_merged             = c()
sterile_comparison_keep    = c()
pathogenic_comparison_keep = c()


path      = "/Users/burcutepekule/Desktop/tregs/mass_sim_results_presampled_123/"
...
results         = read_csv(paste0('/Users/burcutepekule/Desktop/tregs/mass_sim_results_presampled_123/simulation_results_param_set_',i,'.csv'), show_col_types = FALSE)
...
saveRDS(all_comparison_results, '/Users/burcutepekule/Desktop/tregs/all_comparison_results_0_pre_123.rds') 
