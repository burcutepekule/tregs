...
objective_function = function(random_integers, node_summary_counts) {
  ...
  # diff_rat = rep(1/3, 3) - c(better_rat, worse_rat, drift_rat)
  diff_rat = c(0,0,1) - c(better_rat, worse_rat, drift_rat)
...
# Export
write.csv(balanced_lhs_dataset, "balanced_lhs_parameters_drift.csv")
...
ggsave("parameter_distributions_comparison_drift.png", 
       density_plot, 
       width = 16, 
       height = 12, 
       dpi = 300)
