...
path      = "/Users/burcutepekule/Desktop/tregs/mass_sim_results_presampled/"
...
if(start_id<max_index){
  for (i in start_id:max_index){
    ...
    results         = read_csv(paste0('/Users/burcutepekule/Desktop/tregs/mass_sim_results_presampled/simulation_results_param_set_',i,'.csv'), show_col_types = FALSE)
